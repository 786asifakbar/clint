 ...
 <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gray-100">
      ...
      <div className="w-full md:w-1/2 p-4 flex flex-col justify-center">
        ...
        <Typography variant="body1" className="text-justify md:text-left">
         Join us for a historic moment in the promotion of The Help Human Rights Organization of Pakistan is proud to announce the opening ceremony of its efforts across multiple sectors, including health, education, food security, and legal aid. With the presence of our esteemed guests , colonel Amir, this event promises to be a powerful start to our mission. We will also be showcasing our commitment to supporting the elderly in our old age home, providing medicine support to those in need, and providing a safe and nurturing environment for orphans. And that is not all, we are also embarking on our biggest project yet: the construction of a Help Children s Hospital in Lee Market, Karachi.
        </Typography>
      </div>
    </div>
    </>
